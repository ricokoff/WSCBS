...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements net.codejava.CalculatorService {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://codejava.net/", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://codejava.net/", "CalculatorPort"));
        }
